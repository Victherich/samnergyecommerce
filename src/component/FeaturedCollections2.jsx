...
import colImg from "../Images/collectioniumg.jpeg"
...
const style1 ={
    ...
    return (
        <div className='FeaturedCollections' style={{paddingTop:"0px"}}>
            {/* <div className='FeaturedCollectionHeaderImgWrap' style={style1}><h1>FEATURED COLLECTIONS</h1></div> */}
...
export default FeaturedCollections2;
