...
import colImg from "../Images/heroimg7.jpeg"
...
const style1 ={
    ...
    return (
        <div className='FeaturedCollections FeaturedCollectionsB' >
            <div className='FeaturedCollectionHeaderImgWrap' style={style1}><h1>BELLY INN</h1></div>
            
            <div className='Collections'>
                {Data.slice(5,15).map((d)=>(
