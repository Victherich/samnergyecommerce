...
import colImg from "../Images/searchImage.jpeg"
import axios from 'axios';
import { Context } from './Context';

const SearchResult = () => {
    const {loading,setLoading,Data,handleDataDetail,searchResult}=useContext(Context)
...
const style1 ={
    ...
    return (
        <div className='FeaturedCollections FeaturedCollectionsB'>
            <div className='FeaturedCollectionHeaderImgWrap' style={style1}><h1>SEARCH RESULT: FOUND ({searchResult.length}) ITEMS</h1></div>
            
            <div className='Collections'>
                {searchResult.slice(0,18).map((d)=>(
